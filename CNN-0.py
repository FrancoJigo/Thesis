...
training_set = train_datagen.flow_from_directory('images/Training', target_size = (50,50), batch_size = 32, class_mode = 'categorical')

test_set = test_datagen.flow_from_directory('images/Test', target_size = (50,50), batch_size = 32, class_mode='categorical')

classifier.fit_generator(training_set,steps_per_epoch = 8000, epochs = 10, validation_data = test_set, validation_steps = 800)

classifier.save('CNN-0.model')
